...
if __name__ == '__main__':
    with h5py.File("mc_rhos.h5") as h5f:
    ...
    print("Saving")
    np.savez('mc_bisep_results.npz', results_024 = results_024, results_531 = results_531, seed_res_024 = seed_res_024, seed_res_531 = seed_res_531)    
